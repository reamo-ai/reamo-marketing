  ...
  return (
    <div style={{ marginBottom: "2rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: "0.5rem" }}>
        <label style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.85rem", color: "#9999aa", letterSpacing: "0.04em", textTransform: "uppercase" }}>
          {label}
        </label>
        <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1.1rem", color: "#00d4a0", fontWeight: 700 }}>
          {value}{unit}
        </span>
      </div>
      <input
      ...
      />
      {hint && <p style={{ marginTop: "0.4rem", fontSize: "0.75rem", color: "#555566", fontFamily: "'DM Sans', sans-serif" }}>{hint}</p>}
    </div>
  );
}
...
export default function CalculatorClient() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", fontFamily: "'DM Sans', sans-serif", color: "#ffffff", padding: "0", position: "relative", overflow: "hidden" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;800&family=DM+Sans:wght@300;400;500&display=swap');
      ...
      <div style={{ maxWidth: "960px", margin: "0 auto", padding: "3rem 1.5rem 5rem" }}>
        ...
        <div className="fade-up fade-up-1" style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          <div style={{ marginBottom: "1rem" }}>
            <span style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "0.75rem", letterSpacing: "0.2em", textTransform: "uppercase", color: "#00d4a0", background: "rgba(0,212,160,0.08)", border: "1px solid rgba(0,212,160,0.2)", padding: "0.35rem 0.9rem", borderRadius: "100px" }}>Free Tool by Reamo</span>
          </div>
          <h1 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "clamp(2rem, 5vw, 3.2rem)", fontWeight: 800, lineHeight: 1.1, margin: "0.75rem 0", letterSpacing: "-0.02em" }}>
            What&apos;s Your Admin Time<br /><span style={{ color: "#00d4a0" }}>Really Costing You?</span>
          </h1>
          <p style={{ color: "#9999aa", fontSize: "1.05rem", maxWidth: "480px", margin: "1rem auto 0", lineHeight: 1.6 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", alignItems: "start" }}>
          ...
          <div className="fade-up fade-up-2" style={{ background: "#14141e", border: "1px solid #1e1e2e", borderRadius: "16px", padding: "2rem" }}>
            <h2 style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1rem", fontWeight: 700, marginBottom: "2rem", color: "#ffffff", letterSpacing: "0.02em" }}>Your Numbers</h2>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div className="fade-up fade-up-3 result-card" style={{ background: "#14141e", border: "1px solid #1e1e2e", borderRadius: "16px", padding: "1.5rem" }}>
              ...
              <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2.4rem", fontWeight: 800, color: "#ffffff", lineHeight: 1 }}>
            ...
            <div className="fade-up fade-up-3 result-card" style={{ background: "linear-gradient(135deg, #0d1f1a 0%, #14141e 100%)", border: "1px solid rgba(0,212,160,0.25)", borderRadius: "16px", padding: "1.5rem", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2.6rem", fontWeight: 800, color: "#00d4a0", lineHeight: 1 }}>
            ...
            <div className="fade-up fade-up-4 result-card" style={{ background: "#14141e", border: "1px solid #1e1e2e", borderRadius: "16px", padding: "1.5rem" }}>
              ...
              <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "2rem", fontWeight: 800, color: "#ffffff", lineHeight: 1 }}>
            ...
            <div className="fade-up fade-up-4" style={{ background: "#0a0a0f", border: "1px solid #1e1e2e", borderRadius: "12px", padding: "1rem 1.25rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem" }}>
              <div>
                ...
                <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1.1rem", color: "#9999aa", fontWeight: 700 }}>{formatCurrency(reamoCost)}/mo</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1.1rem", color: "#00d4a0", fontWeight: 700 }}>{roiMultiple.toFixed(0)}x return</p>
              </div>
              <div style={{ width: "1px", height: "36px", background: "#1e1e2e" }} />
              <div>
                <p style={{ fontSize: "0.7rem", textTransform: "uppercase", letterSpacing: "0.1em", color: "#555566" }}>Net annual gain</p>
                <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "1.1rem", color: "#ffffff", fontWeight: 700 }}>{formatCurrency(annualROI)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="fade-up fade-up-4" style={{ maxWidth: "560px", margin: "2.5rem auto 0" }}>
          {!submitted ? (
            <div style={{ background: "#14141e", border: "1px solid #1e1e2e", borderRadius: "16px", padding: "2rem", textAlign: "center" }}>
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "1.1rem", marginBottom: "0.4rem" }}>Get your full breakdown + Reamo demo</p>
              ...
              <div style={{ display: "flex", gap: "0.75rem" }}>
                <input type="email" placeholder="your@email.com" value={email} onChange={(e) => setEmail(e.target.value)} onKeyDown={(e) => e.key === "Enter" && handleSubmit()}
                  style={{ flex: 1, background: "#0a0a0f", border: "1px solid #2a2a3a", borderRadius: "8px", padding: "0.75rem 1rem", color: "#ffffff", fontSize: "0.9rem", fontFamily: "'DM Sans', sans-serif", outline: "none" }} />
                <button className="cta-btn" onClick={handleSubmit} disabled={loading}
                  style={{ background: "#00d4a0", color: "#0a0a0f", border: "none", borderRadius: "8px", padding: "0.75rem 1.5rem", fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "0.9rem", cursor: loading ? "not-allowed" : "pointer", whiteSpace: "nowrap", opacity: loading ? 0.7 : 1, boxShadow: "0 4px 20px rgba(0,212,160,0.2)" }}>
            ...
            <div style={{ background: "linear-gradient(135deg, #0d1f1a 0%, #14141e 100%)", border: "1px solid rgba(0,212,160,0.3)", borderRadius: "16px", padding: "2rem", textAlign: "center" }}>
              ...
              <p style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 700, fontSize: "1.1rem", color: "#00d4a0", marginBottom: "0.4rem" }}>You&apos;re on the list.</p>
