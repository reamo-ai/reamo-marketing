...
export default function PlanLandingPage({ plan }: { plan: PlanId }) {
  ...
  return (
    <section className="relative z-10 min-h-screen bg-[var(--color-background)] px-6 py-16 lg:px-8 lg:py-24">
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative mt-8 aspect-video w-full overflow-hidden rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]">
          <video
            controls
            playsInline
            preload="metadata"
        ...
        <div className="mx-auto mt-10 w-fit max-w-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 sm:p-8">
          <div className="flex flex-col gap-8 text-left md:flex-row md:items-start md:gap-0">
            <div className="min-w-0 shrink-0 md:w-[min(100%,16rem)] md:pr-8 lg:w-56">
              ...
              <a
                href={ctaHref}
                className="mt-8 inline-block w-full rounded-lg bg-accent px-6 py-3.5 text-center text-sm font-semibold text-[var(--color-background)] transition-opacity hover:opacity-90 sm:w-auto"
              >
                Get started
              </a>
            </div>
        ...
        <p className="mx-auto mt-10 w-fit max-w-full text-center text-sm text-secondary">
